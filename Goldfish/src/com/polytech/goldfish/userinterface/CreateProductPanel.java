		...
		btnOk.addActionListener(
					new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							int id;
							id = productFacade.createPerson(tfName.getText(), tfDescription.getText());
							JOptionPane.showMessageDialog(null, productFacade.findProductById(id).getSurname() + " " + productFacade.findProductById(id).getName() + " has been created.",
