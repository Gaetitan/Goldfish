		...
		btnOk.addActionListener(
					new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							int id;
							id = activityFacade.createActivity(tfName.getText(), tfDescription.getText());
							JOptionPane.showMessageDialog(null,"The activity " + activityFacade.findActivityById(id).getName() + " has been created.",
